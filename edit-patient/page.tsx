    ...
    return (
      <div className="p-6 md:p-8 max-w-4xl mx-auto">
        <div className="bg-white border border-slate-200 rounded-lg p-6 text-center">
          <p className="text-slate-600">{error || "Kind nicht gefunden"}</p>
          <button 
    ...
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm">
        <div className="border-b border-slate-100 p-6">
          <h1 className="text-2xl font-semibold text-slate-900">Kind bearbeiten</h1>
          <p className="text-slate-600 text-sm mt-1">Kindinformationen aktualisieren</p>
        </div>
        <div className="p-6">
          {error && (
